...
def create_bilstm_cnn_pipeline_de(**kwargs):
    return Pipeline(
        [
            ...
            node(
                func=word2index_padding_dataset
                , inputs=["valid_tokenized", "vocab_bilstm", "params:sentence_size"]
            ...
            node(
                func=word2index_padding_dataset
                , inputs=["test_tokenized", "vocab_bilstm", "params:sentence_size"]
            ...
            node(
                ...
                , inputs=["word2vec_bilstm", "vocab_bilstm"]
